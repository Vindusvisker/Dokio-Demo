  ...
  return (
    <div className="fixed top-3 left-1/2 transform -translate-x-1/2 z-50">
      <div className="flex items-center justify-center">
        <div className="flex items-center space-x-2 bg-black/20 backdrop-blur-xl rounded-full p-1 border border-white/10 shadow-2xl">
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative flex items-center space-x-1 px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-500 overflow-hidden group",
                  isActive 
